...
Turns out you need a formula that accounts for how human eyes actually perceive colour (because we're way more sensitive to green than blue, the distance calculation has to compensate). Same with Dithering. Floyd-Steinberg looks simple until you realise the browser's Uint8ClampedArray quietly kills your error propagation precision and you get ugly banding instead of smooth gradients 🤡.
